...
if(!startsWith(mime_content_type($_FILES['fileToUpload']['tmp_name']), "image")){
    echo "Arquivo não enviado pois o arquivo não é imagem!<br>";
}else{
    if(!empty($_POST['dataURL'])){
        ...
        $imgreconstruct = base64tojpeg($_POST["dataURL"], incrementFilename($_FILES["fileToUpload"]["name"],$target_dir));
